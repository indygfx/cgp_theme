...
$etcolor1 = elgg_get_plugin_setting('etcolor1','cgp_theme');
$etcolor2 =  elgg_get_plugin_setting('etcolor2','cgp_theme');
$et_bkimg = 'url(\'<?php echo $vars[\'url\']; ?>mod/cgp_theme/graphics/bkgr.gif\')';
$et_headimg = 'url(\'<?php echo $vars[\'url\']; ?>mod/cgp_theme/graphics/headimg.jpg\')';
$etpgwidth = elgg_get_plugin_setting('etpgwidth','cgp_theme');
$etfooth =  elgg_get_plugin_setting('etfooth','cgp_theme');
$etfootbk =  elgg_get_plugin_setting('etfootbk','cgp_theme');
$etfootlink = elgg_get_plugin_setting('etfootlink','cgp_theme');
$etfoothov = elgg_get_plugin_setting('etfoothov','cgp_theme');
$etfoottext = elgg_get_plugin_setting('etfoottext','cgp_theme');
$etsearch = elgg_get_plugin_setting('etsearch','cgp_theme');
$etheadh = elgg_get_plugin_setting('etheadh','cgp_theme');
$etmenu = elgg_get_plugin_setting('etmenu','cgp_theme');
$etintro = elgg_get_plugin_setting('etintro','cgp_theme');

//this bit writes the file...
$file = elgg_get_data_path() . "cgp_theme/cssinc.php";
...
//this bit writes the file...
$file2 = elgg_get_data_path() . "cgp_theme/intro.php";
...
elgg_unset_plugin_setting ('etintro','cgp_theme');
