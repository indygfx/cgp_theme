...
Note: Adding a "Site Introduction" requires the "Custom Index" plugin. (If you want to use Custom Index without the introduction - you can remove the file  'mod/easytheme/views/default/page/layouts/custom-index.php' and Custom Index will return to its default layout.)
