...
echo "<p><strong>You need to complete this form, and save it, before you can use cgp_theme.</strong></p><p>[1] First choose your <strong>HEADER IMAGE</strong> and save it as headimg.jpg in 'mod/cgp_theme/graphics'. <em>(Choose your image carefully - make sure it is the right width and height for the header of your page.)</em></p><p>[2] How wide is your image? <em> - this determines the Width of the Centred panel (Theme default = 990px)</em></p> ";  
...
echo "<br><br><p>[6] For the <strong>PAGE BACKGROUND</strong>:<br>  Open <strong>'mod/cgp_theme/graphics/bkgr.gif'</strong> in your graphics software, and edit the colours. See my tutorial at <a style=\"color:red\" href=\"http://www.jubo.co.uk/blog/2011/11/easy-theme-1-2-elgg-1-8-theme\" target=\"_blank\">jubo.co.uk</a><br>Then... save your image as bkgr.gif in 'mod/cgp_theme/graphics'. <br><em>(Or you could replace this image with a repeating image of your choice - any size - just name it 'bkgr.gif'.)</em></p><br><p>[7] If you want a different <strong>SIDEBAR</strong> colour:<br> Open <strong>'mod/cgp_theme/graphics/sidebar_background.gif'</strong> and change the colour of the grey section<br>Then... save your image as sidebar_background.gif in 'mod/cgp_theme/graphics'.</p><br>"; 
...
echo "<br><br><p>[16] <strong> To Replace the site name with a Logo image</strong> <em>(optional)</em>:<br>~ Save your logo in 'mod/cgp_theme/graphics' <br> ~ Open the file 'mod/cgp_theme/views/default/page/elements/header_logo.php'<br> ~ Remove the 'h1' tags, and everything in between.<br> ~ Replace with the code for your logo image.<br> ~ Save the file.</p><br><p>[17] <strong>To change the Favicon icon</strong> <em>(optional)</em>: Swap your sites icon with the elgg favicon icon in <strong>'mod/cgp_themem/graphics'</strong></p><br><br><p><strong>Site Introduction</strong> Write a short introduction to your site (100 - 150words) - <em>(This will appear at the top of the custom index page.  Be careful to copy/paste from a text file - otherwise it's easy to paste unwanted mark-up into the box.)</em></p>";
